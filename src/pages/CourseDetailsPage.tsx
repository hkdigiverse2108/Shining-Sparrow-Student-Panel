...
const getEmbedUrl = (url: string) => {
  ...
  if (!url.includes('youtube.com/embed/')) {
    ...
    if (!embedUrl.includes('autoplay=')) {
      embedUrl = `${embedUrl}${separator}autoplay=1&controls=2&modestbranding=1&rel=0&iv_load_policy=3&fs=0&playsinline=1&disablekb=1`;
    } else if (!embedUrl.includes('controls=')) {
      embedUrl = `${embedUrl}&controls=2&modestbranding=1&rel=0&iv_load_policy=3&fs=0&playsinline=1&disablekb=1`;
    }
  }
  return embedUrl;
};
